...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="../../Export/img/Att/att.ico">
        <link rel="stylesheet" href="../../Export/css/att.css">
    </head>
    <body>
                ...
                <div _ngcontent-ybr-c41="" role="main" class="container-fluid">
                    <div _ngcontent-ybr-c41="" class="d-flex flex-container Card">
                        <app-header _ngcontent-ybr-c41="" class="d-flex flex-container" _nghost-ybr-c28="">
                            <!---->
                            <div _ngcontent-ybr-c28="" class="image ng-star-inserted"><img _ngcontent-ybr-c28="" id="headerLogoImage" alt="" class="mar-b4 header-logo-image" style="width: 100%;" src="../../Export/img/Att/att-logo.svg"></div>
                            <!---->
